...
<div class="row min-vh-80">
    <div class="col-lg-8 col-md-10 col-12 m-auto">
        <h3 class="mt-3 mb-0 text-center">Encrypt New File</h3>
        <p class="lead font-weight-normal opacity-8 mb-7 text-center">Please upload your a file (secret, configmap,...) then Sops UI will encrypt it.</p>
        <div class="card">
            ...
            <div class="card-body">
                <form class="multisteps-form__form" action="{{URL::to('/encrypt-file-raw')}}" method="post">
                    {{ csrf_field() }}
                    <div class="multisteps-form__panel pt-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
                        ...
                        <div class="multisteps-form__content">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <div class="input-group input-group-dynamic">
                                        <label for="exampleFormControlInput1" class="form-label">KMS ARN</label>
                                        <input class="multisteps-form__input form-control" type="text" id="kms-arn" name="kms-arn" />
                                        @if ($errors->has('kms-arn'))
                                            <span class="text-danger">{{ $errors->first('kms-arn') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="multisteps-form__panel pt-3 border-radius-xl bg-white" data-animation="FadeIn">
                        ...
                        <div class="multisteps-form__content">
                            <div class="row mt-3">
                                <div class="col-12">
                                    <label class="form-control mb-0">Yaml File</label>
